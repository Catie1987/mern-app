      ...
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-base mt-5'>
            Welcome to La.Blog website, please sign-up or sign-in to use up all feature. Start to write your story and share memory with your beloved here.
          </p>
        </div>
        {/* right */}
